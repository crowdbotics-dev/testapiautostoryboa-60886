...
## Project Structure
    ...
    ├── testapiautostoryboa_60886  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_60886`
...
2. Clone this repo and `cd testapiautostoryboa_60886`
